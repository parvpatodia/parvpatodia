...
**Languages**: Python, JavaScript/TypeScript, C++, ROS

**AI and Machine Learning**: PyTorch, TensorFlow, scikit-learn, Hugging Face. I've built NLP models, worked with computer vision and object detection, implemented federated learning systems, and lately been focused on video understanding and semantic search. Also have experience with PINNs (Physics-Informed Neural Networks) for simulating real-world systems.

**Backend and APIs**: FastAPI is what I reach for most. I can design REST APIs, work with databases, think through system architecture, and get something from idea to production.

**Frontend**: React, TypeScript, HTML/CSS. I like building things that are actually usable, not just functional. The full-stack part matters to me because you see how the entire system comes together.

**Databases and Infrastructure**: Supabase, PostgreSQL, working with cloud platforms for development and testing. I've deployed systems and know what breaks in production.

**Robotics and Autonomous Systems**: ROS, LiDAR, real-time perception systems. I tested AV perception modules and spent time thinking about how robots actually see and understand the world.
...
Most of my interesting work will show up here as I push projects. Right now I'm building the foundation. When something is worth sharing, you'll see it pinned.

If you want to talk about AI systems, building full-stack products, robotics, or just why mechanical engineers make weirdly good software engineers, let's connect.

**LinkedIn**: https://www.linkedin.com/in/parvpatodia-ai-silicon-valley/

**Email**: parvpatodia09@gmail.com
